...
266                                                                                                       \{
267 
268     \hyperlink{class_objects_handler_a968feba95e0707919b6c3632781510ba}{chaser\_spawn}(*chaser\_init\_pose);    
269 \}
\end{DoxyCode}
...
\begin{DoxyCode}
249                                                        \{
250     ROS\_INFO\_ONCE(\textcolor{stringliteral}{"[Objects handler] spawning chaser."}); 
251     
252     \hyperlink{class_objects_handler_a86f8528ff5697c87fc6a3fcd6ba0f42c}{is\_chaser\_recieved} = \textcolor{keyword}{true};
253     \hyperlink{class_objects_handler_a16165ae7c0167ba8d2a0151a8a4fbfd5}{is\_chaser\_spawned} = \textcolor{keyword}{true};    
254     
255     \textcolor{keywordflow}{if}(\hyperlink{class_objects_handler_a95908d5b00f62b629dc7f20acb714292}{run\_mode} == 0)\{
256         \hyperlink{class_objects_handler_a79fd5f872a40cca5ea599f1e83dcb3ad}{chaser\_pose} = spawn\_pose;
257         \hyperlink{class_objects_handler_a79fd5f872a40cca5ea599f1e83dcb3ad}{chaser\_pose}.pose.position.z = \hyperlink{class_objects_handler_aa991434e17ca1144c80633ff7530534c}{chaser\_init\_z};
258 
259     \}\textcolor{keywordflow}{else}\{
260         \textcolor{comment}{// hover command }
261         
262     \}
263 
264 \}
...
\begin{DoxyCode}
117 \{\textcolor{keywordflow}{return} \hyperlink{class_objects_handler_a36db60068ada56b9142b3d6ef0437749}{chaser\_acc};\};
\end{DoxyCode}
...
\begin{DoxyCode}
114 \{\textcolor{keywordflow}{return} \hyperlink{class_objects_handler_a79fd5f872a40cca5ea599f1e83dcb3ad}{chaser\_pose};\};
\end{DoxyCode}
...
\begin{DoxyCode}
116 \{\textcolor{keywordflow}{return} \hyperlink{class_objects_handler_a74e3f3b4bf263711c389190a595368e2}{chaser\_vel};\};
\end{DoxyCode}
...
\begin{DoxyCode}
120 \{\textcolor{keywordflow}{return} \hyperlink{class_objects_handler_af2063609510d5ad8f136a275b0d127c1}{edf\_grid\_ptr}.get();\};
\end{DoxyCode}
...
\begin{DoxyCode}
119 \{\textcolor{keywordflow}{return} \hyperlink{class_objects_handler_a76ad7ca7513755408c02dd36dea94c6e}{octree\_ptr}.get();\};
\end{DoxyCode}
...
\begin{DoxyCode}
108                                             \{
109     PoseStamped pose(\hyperlink{class_objects_handler_ad436bfd8b262f473f0e4ca92b3c3402b}{target\_pose}); 
110     pose.pose.position.z = \hyperlink{class_objects_handler_ac8c10c7a10aeb8abf1a44b7361f646e6}{min\_z}; 
111     \textcolor{keywordflow}{return} pose;
112 \};
\end{DoxyCode}
...
25 
26     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.action = visualization\_msgs::Marker::ADD;
27     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.type = visualization\_msgs::Marker::CUBE\_LIST;      
28     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.pose.orientation.x = 0;
29     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.pose.orientation.y = 0;
30     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.pose.orientation.z = 0;
31     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.pose.orientation.w = 1;                  
32     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.scale.x = \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_a520406c76b3abf392401626bc2161370}{resolution};
33     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.scale.y = \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_a520406c76b3abf392401626bc2161370}{resolution};
34     \hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf}.scale.z = \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_a520406c76b3abf392401626bc2161370}{resolution};
35     
36     
37     \textcolor{comment}{// topics }
38     \hyperlink{class_objects_handler_aea45bba31aa769008386100725bda66b}{tf\_listener} = \textcolor{keyword}{new} (tf::TransformListener);
39     \hyperlink{class_objects_handler_af49de4eabb124e2ee6c9e12ebb31bca3}{tf\_talker} = \textcolor{keyword}{new} (tf::TransformBroadcaster);
40 
41     \hyperlink{class_objects_handler_a86a1f98983b533f77bf17867affb5251}{pub\_edf} = nh.advertise<visualization\_msgs::Marker>(\textcolor{stringliteral}{"edf\_grid"},1);
42 
43     \textcolor{comment}{// octomap            }
44     nh.param(\textcolor{stringliteral}{"is\_octomap\_full"},this->\hyperlink{class_objects_handler_a56f70ac04c01e8b948a4b44fa5670f49}{is\_octomap\_full},\textcolor{keyword}{true});
45     \hyperlink{class_objects_handler_a76ad7ca7513755408c02dd36dea94c6e}{octree\_ptr}.reset(\textcolor{keyword}{new} octomap::OcTree(0.1)); \textcolor{comment}{// arbitrary init}
46     \textcolor{keywordflow}{if} (\hyperlink{class_objects_handler_a56f70ac04c01e8b948a4b44fa5670f49}{is\_octomap\_full})
47         \hyperlink{class_objects_handler_a3b384ae3f8f66557b1c1ac04523fb330}{sub\_octomap} = nh.subscribe(\textcolor{stringliteral}{"/octomap\_full"},1,&
...
49         \hyperlink{class_objects_handler_a3b384ae3f8f66557b1c1ac04523fb330}{sub\_octomap} = nh.subscribe(\textcolor{stringliteral}{"/octomap\_binary"},1,&
      \hyperlink{class_objects_handler_a5744110d979850b3e2d8896793435d0c}{ObjectsHandler::octomap\_callback},\textcolor{keyword}{this});   
50 
51     \hyperlink{class_objects_handler_a9a2e098b85260b71c88b81dadd6ca58a}{sub\_chaser\_init\_pose} = nh.subscribe(\textcolor{stringliteral}{"/chaser\_init\_pose"},1,&
...
52     
53     ROS\_INFO(\textcolor{stringliteral}{"Object handler initialized."}); 
54 \}
\end{DoxyCode}
...
91         ROS\_INFO(\textcolor{stringliteral}{"[Objects handler] dynamic EDT computed in %f [sec]"},diff);
92 
93         \textcolor{comment}{// generate homogenous grid }
94         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_ae702824fca4d3a4b4bbf4ac90084e3a7}{x0} = boundary\_min.x();
95         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_ae9d400dadcfaaff44706adae06664c83}{y0} = boundary\_min.y();
96         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_a51178f64cc93a37d6d8f774228c24a0f}{z0} = \hyperlink{class_objects_handler_ac8c10c7a10aeb8abf1a44b7361f646e6}{min\_z};
97         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_a9738077907a76512e49cb284ee3f1949}{lx} = boundary\_max.x() - boundary\_min.x();
98         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_afb39ded77b5714992e9b2f8c5d735d30}{ly} = boundary\_max.y() - boundary\_min.y();
99         \hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}.\hyperlink{struct_field_params_ae7532b58aed59f5b47233e57b67acc1a}{lz} = (boundary\_max.z() - \hyperlink{class_objects_handler_ac8c10c7a10aeb8abf1a44b7361f646e6}{min\_z});
100         \hyperlink{class_objects_handler_af2063609510d5ad8f136a275b0d127c1}{edf\_grid\_ptr}.reset(\textcolor{keyword}{new} \hyperlink{struct_grid_field}{GridField}(\hyperlink{class_objects_handler_a46ed8cfd250b183909a7d3a1f56cee6b}{edf\_grid\_params}));
101         \hyperlink{class_objects_handler_ae6da4f0f0a265c75722e02d68d519f07}{compute\_edf}();
102 
103         is\_map\_recieved = \textcolor{keyword}{true};
104     \}
105 \};
\end{DoxyCode}
...
244                             \{
245 
246     \hyperlink{class_objects_handler_a86a1f98983b533f77bf17867affb5251}{pub\_edf}.publish(\hyperlink{class_objects_handler_ad6904dcaaad790234569760df0fb0ac2}{markers\_edf});
247 \}
\end{DoxyCode}
...
124     
125     
126     \textcolor{keywordflow}{if}(\hyperlink{class_objects_handler_a95908d5b00f62b629dc7f20acb714292}{run\_mode} == 1)\{
127         \textcolor{comment}{// mode 1 : gazebo simulation mode }
128         \textcolor{comment}{// chaser and target to be listened }
129         \textcolor{keywordtype}{string} objects\_frame\_id[2];
130         objects\_frame\_id[0] = \hyperlink{class_objects_handler_a7a616768386c4c7da9af4da3d07bd936}{target\_frame\_id};
131         objects\_frame\_id[1] = \hyperlink{class_objects_handler_a3e8d08bf5d76d69f1768b53fd799953c}{chaser\_frame\_id};
132         
133         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0;i<2;i++)\{            
134             tf::StampedTransform transform;    
135             \textcolor{comment}{// }
136             \textcolor{keywordflow}{try}\{
137                 \hyperlink{class_objects_handler_aea45bba31aa769008386100725bda66b}{tf\_listener}->lookupTransform(\hyperlink{class_objects_handler_a1c0586ae7467bb8a3df8ad247ac7b10b}{world\_frame\_id},objects\_frame\_id[i],
      ros::Time(0), transform);
138                 PoseStamped pose\_stamped;
139                 pose\_stamped.header.stamp = ros::Time::now();
140                 pose\_stamped.header.frame\_id = \hyperlink{class_objects_handler_a1c0586ae7467bb8a3df8ad247ac7b10b}{world\_frame\_id};
141 
142                 pose\_stamped.pose.position.x = transform.getOrigin().getX();
143                 pose\_stamped.pose.position.y = transform.getOrigin().getY();
144                 pose\_stamped.pose.position.z = transform.getOrigin().getZ();
145 
146                 pose\_stamped.pose.orientation.x = transform.getRotation().getX();
147                 pose\_stamped.pose.orientation.y = transform.getRotation().getY();
148                 pose\_stamped.pose.orientation.z = transform.getRotation().getZ();
149                 pose\_stamped.pose.orientation.w = transform.getRotation().getW();
150 
151 
152 
